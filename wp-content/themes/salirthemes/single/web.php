<?php
/*
Template Name: single - Discography - WebSite
*/
?>
...
<main id="main">
 ...
 <div id="container">
  <div id="contents">
   ...
   <a class="zoom" href="<?php the_field('screen'); ?>" title="<?php the_title(); ?>" data-lity>
   <img src="<?php the_field('screen'); ?>" alt="<?php the_title(); ?>">
   </a>
   <?php endif; ?>
   </div>
   <dl id="createinfo">
    <dt><span class="title">ＵＲＬ</span></dt>
	<dd><a href="#">
	<?php if(get_field('url')): ?>
	<a href="<?php the_field('url'); ?>" target="_blank" title="<?php the_title(); ?>"><?php the_field('url'); ?></a>
	<?php endif; ?>
	</dd>
